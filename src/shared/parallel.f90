...
!
  ...
  subroutine isend_cr_device(sendbuf_d, sendcount, dest, sendtag, req)
  ...
  type(c_ptr), value :: sendbuf_d
  integer :: sendcount, dest, sendtag, req
  integer :: ier

  call MPI_ISEND(sendbuf_d,sendcount,CUSTOM_MPI_TYPE,dest,sendtag,my_local_mpi_comm_world,req,ier)

  end subroutine isend_cr_device
