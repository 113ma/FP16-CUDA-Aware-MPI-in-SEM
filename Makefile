...
FC = gfortran
FCFLAGS = -g -O2 ${DEBUG_COUPLED_FLAG}
FC_DEFINE = -D
MPIFC = mpif90
MPILIBS = 

FLAGS_CHECK = -std=f2008 -fimplicit-none -fmax-errors=10 -pedantic -pedantic-errors -Waliasing -Wampersand -Wcharacter-truncation -Wline-truncation -Wsurprising -Wno-tabs -Wunderflow -ffpe-trap=invalid,zero,overflow -Wunused -O3 -finline-functions
...
MPI_INCLUDES =  -I/usr/lib/x86_64-linux-gnu/openmpi/lib/../../fortran/gfortran-mod-15/openmpi
...
CUDA_FLAGS = 
CUDA_INC =  -I${SETUP}
CUDA_LINK = -L/usr/local/cuda/lib64 -lcudart -lstdc++
...
GENCODE_89 = -gencode=arch=compute_89,code=\"sm_89,compute_89\"
# cuda preprocessor flag
# CUDA version 12.0
GENCODE = $(GENCODE_89) $(FC_DEFINE)GPU_DEVICE_Ada
# CUDA version 11.0
...
#FCFLAGS += $(FC_DEFINE)USE_OPENMP -fopenmp
